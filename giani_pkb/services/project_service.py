...
class ProjectService:
    ...
    def create_project(self, user_id: str, project_name: str, description: str = None) -> Dict[str, Any]:
    ...
    def get_user_projects(self, user_id: str) -> List[Dict[str, Any]]:
        ...
        try:
            projects = self.db_manager.get_user_projects(uuid.UUID(user_id) if isinstance(user_id, str) else user_id)
            return projects
    ...
    def get_project_details(self, project_id: str, user_id: str) -> Optional[Dict[str, Any]]:
        """Get project details by ID."""
        try:
            project = self.db_manager.get_project(project_id, uuid.UUID(user_id) if isinstance(user_id, str) else user_id)
            return project
    ...
    def delete_project(self, project_id: str, user_id: str) -> bool:
        ...
        try:
            ...
            success = self.db_manager.delete_project(project_id, uuid.UUID(user_id) if isinstance(user_id, str) else user_id)
    ...
    def search_project_documents(self, project_id: str, user_id: str,
                                query: str, category: str = None) -> List[Dict[str, Any]]:
