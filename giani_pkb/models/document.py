"""
Data models for document metadata and related structures.
"""
...
class DocumentMetadata:
    """
    Data model representing metadata for a document in the system.

    This class contains all the essential information about a document including
    its classification, storage location, and processing status.
    """
    id: str
...
class Chunk:
    """
    Data model representing a chunk of document content.

    TODO: Review and reconcile/merge with ChunkMetadata in preprocessing.chunking_strategies.py
    """
    ChunkID: str
    DocumentID: str
    ProjectID: str
    ChunkTextContent: str
    SourcePageNumber: Optional[list[int]] = field(default_factory=list)
    StructuralMetadataJson: Optional[Dict[str, Any]] = field(default_factory=dict)
    VectorID: Optional[str] = None
    EmbeddingChecksum: Optional[str] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'Chunk':
        ...
        """
        import dataclasses
        # Basic from_dict, can be expanded with mapping if needed
